...
const Game = {
    ...
    audio: {
        ...
        overallVolume: .15 * volume_request
    },
    user: undefined,
    ...
    initArenas()
    {
        var button1 = new Button(120, 310, 100, 130, this,'images/fire_button.png', 'images/tmp_button.png')
        var button2 = new Button( 430, 310, 100, 130, this,'images/ice_button.png', 'images/tmp_button.png')
...
//                const carsToKill = []
    ...
    initiateAudio() {
        ...
        this.audio.tracks.runFloorSong.volume = .1 * volume_request
        this.audio.tracks.coinsSong.volume = .1 * volume_request
        this.audio.tracks.warningSong.volume = .1 * volume_request
        this.audio.tracks.truck.volume = .1 * volume_request
        this.audio.tracks.electricitySong.volume = .1 * volume_request
        this.audio.tracks.shotsSong.volume = .1 * volume_request
        this.audio.tracks.rocketSong.volume = .1 * volume_request
        volume_request ? this.audio.tracks.breakWallSong.play() : undefined;
