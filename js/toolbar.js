class Toolbar {
    constructor(gctx) {
        ...
        //create all buttons
        this.ranking_btn = new Button(340, 30, 35, 35, undefined, undefined, ranking_btn_handler)
        this.iotex_btn = new Button(400, 30, 35, 35, undefined, undefined, iotex_btn_handler)
